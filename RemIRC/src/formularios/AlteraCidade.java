 ...
 * @author CEDUP TIMBO
 */
public class AlteraCidade extends javax.swing.JFrame {

    DefaultTableModel dtmTabela = new DefaultTableModel(null, new String[]{"Codigo da cidade", "Cidade", "Codigo do estado", });
    /**
     * Creates new form AlteraCidade
     */
    public AlteraCidade() {
        initComponents();
        
    }
    public AlteraCidade(List<Object> l) {
        montaTabela(l);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlteraCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(AlteraCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(AlteraCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlteraCidade().setVisible(true);
            }
        });
    }
    ...
    private void montaTabela(List<Object> l) {
